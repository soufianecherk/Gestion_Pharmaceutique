...
class Ui_Form6(object):
    def setupUi(self, Form):
        ...
        self.pushButton = QtWidgets.QPushButton(Form, clicked = lambda: self.Search())
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Clients normaux"))
        self.label.setText(_translate("Form", "Clients normaux"))
        self.update()
